...
class CreateCoursePage(BasePage):
    ...
    def check_visible_image_upload_preview_view(self, is_image_uploaded: bool = False):
    ...
    def check_visible_create_course_form(
        ...
        expect(self.create_course_title_input).to.have_value(title)

        expect(self.create_course_estimated_time_input).to_be_visible()
        expect(self.create_course_estimated_time_input).to.have_value(estimated_time)
    ...
    def click_delete_exercise_button(self, index: int):
        delete_exercise_button = self.page.get_by_test_id(f'create-course-exercise-{index}-box-toolbar-subtitle-text')
